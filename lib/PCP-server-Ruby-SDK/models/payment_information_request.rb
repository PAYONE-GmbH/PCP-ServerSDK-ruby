  ...
  class PaymentInformationRequest
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `PCPServerSDK::PaymentInformationRequest` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `PCPServerSDK::PaymentInformationRequest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @amount_of_money.nil?
        invalid_properties.push('invalid value for "amount_of_money", amount_of_money cannot be nil.')
      end
      ...
      if @payment_product_id.nil?
        invalid_properties.push('invalid value for "payment_product_id", payment_product_id cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @amount_of_money.nil?
      return false if @type.nil?
      return false if @payment_channel.nil?
      return false if @payment_product_id.nil?
      return false if @payment_product_id > 99999
      return false if @payment_product_id < 0
