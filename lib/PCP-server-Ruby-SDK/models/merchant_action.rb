...
module PCPServerSDK
  module Models
    class MerchantAction < ModelBase
      ...
      attribute :action_type, :actionType, :String, enum: ["REDIRECT", "SHOW_FORM", "SHOW_INSTRUCTIONS", "SHOW_TRANSACTION_RESULTS", "MOBILE_THREEDS_CHALLENGE", "CALL_THIRD_PARTY"]
