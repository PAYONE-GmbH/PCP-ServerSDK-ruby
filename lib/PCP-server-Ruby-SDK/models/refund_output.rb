...
module PCPServerSDK
  module Models
    ...
    class RefundOutput < PCPServerSDK::ApiModel
      ...
      def to_hash
        ...
        hash['paymentMethod'] = @paymentMethod unless @payment_method.nil?
        hash
      end
      ...
      def from_hash(hash)
        ...
        @paymentMethod = hash['paymentMethod'] if hash.key? 'paymentMethod'
      end
    end
  end
end
