...
module PCPServerSDK
  ...
  class Customer
    ...
    def list_invalid_properties
      ...
      if !@fiscal_number.nil? && @fiscal_number.to_s.length > 14
        invalid_properties.push('invalid value for "fiscal_number", the character length must be smaller than or equal to 14.')
      end
    ...
    def valid?
      ...
      return false if !@fiscal_number.nil? && @fiscal_number.to_s.length > 14
    ...
    # Custom attribute writer method with validation
    # @param [Object] fiscal_number Value to be assigned
    def fiscal_number=(fiscal_number)
      if fiscal_number.nil?
        fail ArgumentError, 'fiscal_number cannot be nil'
      end

      if fiscal_number.to_s.length > 14
        fail ArgumentError, 'invalid value for "fiscal_number", the character length must be smaller than or equal to 14.'
      end
