  ...
  class PaymentInformationResponse
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `PCPServerSDK::PaymentInformationResponse` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `PCPServerSDK::PaymentInformationResponse`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if !@merchant_customer_id.nil? && @merchant_customer_id.to_s.length > 20
        invalid_properties.push('invalid value for "merchant_customer_id", the character length must be smaller than or equal to 20.')
      end
      ...
      if !@terminal_id.nil? && @terminal_id.to_s.length < 8
        invalid_properties.push('invalid value for "terminal_id", the character length must be great than or equal to 8.')
      end
    ...
    def valid?
      ...
      return false if !@merchant_customer_id.nil? && @merchant_customer_id.to_s.length > 20
    ...
    def merchant_customer_id=(merchant_customer_id)
      ...
      if merchant_customer_id.to_s.length > 20
        fail ArgumentError, 'invalid value for "merchant_customer_id", the character length must be smaller than or equal to 20.'
      end
    ...
    def terminal_id=(terminal_id)
      if terminal_id.nil?
        fail ArgumentError, 'terminal_id cannot be nil'
      end

      if terminal_id.to_s.length > 8
        fail ArgumentError, 'invalid value for "terminal_id", the character length must be smaller than or equal to 8.'
      end

      if terminal_id.to_s.length < 8
        fail ArgumentError, 'invalid value for "terminal_id", the character length must be great than or equal to 8.'
      end
    ...
    def card_acceptor_id=(card_acceptor_id)
      ...
      if card_acceptor_id.to_s.length > 15
