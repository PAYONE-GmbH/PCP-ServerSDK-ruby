...
module PCPServerSDK
  ...
  class StatusOutput
    ...
    def payment_status=(payment_status)
      validator = EnumAttributeValidator.new('String', ["WAITING_FOR_PAYMENT", "PAYMENT_NOT_COMPLETED", "PAYMENT_COMPLETED", "NO_PAYMENT"])
    ...
    def open_amount=(open_amount)
      ...
      if open_amount > 999999999999
        fail ArgumentError, 'invalid value for "open_amount", must be smaller than or equal to 999999999999.'
      end

      if open_amount < 0
        fail ArgumentError, 'invalid value for "open_amount", must be greater than or equal to 0.'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] collected_amount Value to be assigned
    def collected_amount=(collected_amount)
      if collected_amount.nil?
        fail ArgumentError, 'collected_amount cannot be nil'
      end

      if collected_amount > 999999999999
        fail ArgumentError, 'invalid value for "collected_amount", must be smaller than or equal to 999999999999.'
      end

      if collected_amount < 0
        fail ArgumentError, 'invalid value for "collected_amount", must be greater than or equal to 0.'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] cancelled_amount Value to be assigned
    def cancelled_amount=(cancelled_amount)
      if cancelled_amount.nil?
        fail ArgumentError, 'cancelled_amount cannot be nil'
      end

      if cancelled_amount > 999999999999
        fail ArgumentError, 'invalid value for "cancelled_amount", must be smaller than or equal to 999999999999.'
      end

      if cancelled_amount < 0
        fail ArgumentError, 'invalid value for "cancelled_amount", must be greater than or equal to 0.'
      end
    ...
    def refunded_amount=(refunded_amount)
      ...
      if refunded_amount > 999999999999
        fail ArgumentError, 'invalid value for "refunded_amount", must be smaller than or equal to 999999999999.'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] chargeback_amount Value to be assigned
    def chargeback_amount=(chargeback_amount)
      if chargeback_amount.nil?
        fail ArgumentError, 'chargeback_amount cannot be nil'
      end

      if chargeback_amount > 999999999999
        fail ArgumentError, 'invalid value for "chargeback_amount", must be smaller than or equal to 999999999999.'
      end

      if chargeback_amount < 0
        fail ArgumentError, 'invalid value for "chargeback_amount", must be greater than or equal to 0.'
      end
