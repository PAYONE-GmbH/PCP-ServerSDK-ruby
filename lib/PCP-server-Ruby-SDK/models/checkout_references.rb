...
class CheckoutReferences
  ...
  def self.attribute_map
    {
      ...
      :'merchant_shop_reference' => :'merchantShopReference'
    }
  end
  ...
  def self.openapi_types
    {
      ...
      :'merchant_shop_reference' => :'String'
    }
  end
  ...
  def initialize(attributes = {})
    if (!attributes.is_a?(Hash))
      fail ArgumentError, "The input argument (attributes) must be a hash in `CheckoutReferences` initialize method"
    end

    # check to see if the attribute exists and convert string to symbol for hash key
    attributes = attributes.each_with_object({}) { |(k, v), h|
      if (!self.class.attribute_map.key?(k.to_sym))
        fail ArgumentError, "`#{k}` is not a valid attribute in `CheckoutReferences`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
      end
      h[k.to_sym] = v
    }
    ...
    if attributes.key?(:'merchant_shop_reference')
      self.merchant_shop_reference = attributes[:'merchant_shop_reference']
    end
  end
