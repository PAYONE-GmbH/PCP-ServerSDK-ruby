...
module PCPServerSDK
  module Models
    ...
    class CartItemPatch < PCPServerSDK::ApiModel
      # @return [PCPServerSDK::Models::CartItemInvoiceData, nil]
      attr_accessor :invoice_data

      # @return [PCPServerSDK::Models::OrderLineDetailsPatch, nil]
      ...
      def from_hash(hash)
        ...
        if hash.key? 'orderLineDetails'
          @order_line_details = OrderLineDetailsPatch.new_from_hash(hash['orderLineDetails'])
        end
      end
    end
  end
