...
require_relative 'PCP-server-Ruby-SDK/models/pause_payment_response'
require_relative 'PCP-server-Ruby-SDK/models/pause_payment_request'
require_relative 'PCP-server-Ruby-SDK/models/payee'
...
require_relative 'PCP-server-Ruby-SDK/models/payment_information_refund_request'
require_relative 'PCP-server-Ruby-SDK/models/payment_information_refund_response'
...
require_relative 'PCP-server-Ruby-SDK/models/refresh_type'
...
# applepay
require_relative 'PCP-server-Ruby-SDK/models/applepay/apple_pay_payment'
require_relative 'PCP-server-Ruby-SDK/models/applepay/apple_pay_payment_contact'
require_relative 'PCP-server-Ruby-SDK/models/applepay/apple_pay_payment_data'
require_relative 'PCP-server-Ruby-SDK/models/applepay/apple_pay_payment_data_header'
