...
RSpec.describe ApiErrorResponseException do
  let(:status_code) { 500 }
  ...
  describe "#initialize" do
    it "sets attributes" do
      exception = described_class.new(status_code, response_body, errors)
    ...
    it "sets empty errors when not provided" do
      exception = described_class.new(status_code, response_body)
